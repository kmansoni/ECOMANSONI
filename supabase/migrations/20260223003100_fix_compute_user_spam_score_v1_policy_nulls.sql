-- Anti-abuse: harden compute_user_spam_score_v1 against missing policy rows
-- Ensures penalty values are never NULL.
...
BEGIN
  ...
  WITH active_override AS (
    ...
    FROM public.trust_weight_overrides
    WHERE user_id = p_user_id
