-- Fix: emit_decision_event idempotency lookup
-- Bug: `result_payload->'event_id'::uuid` casts the literal 'event_id' to uuid due to precedence.
-- Also fixes incorrect INTO targets when fetching created_at.
