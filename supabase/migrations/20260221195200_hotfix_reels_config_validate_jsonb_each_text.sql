-- ============================================================================
-- HOTFIX: Reels Config Validation v1.0 - Fix jsonb_each_text column name
--
-- Issue: jsonb_each_text returns 'value' not 'val'
-- ============================================================================
...
BEGIN
  ...
  IF p_config ? 'weights' THEN
    ...
    ELSE
      -- Check each weight value is in [0,1] and sum ~= 1.0 (FIXED: use 'value' not 'val').
