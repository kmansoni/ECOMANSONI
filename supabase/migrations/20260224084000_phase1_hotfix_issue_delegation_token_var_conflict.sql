-- Phase 1 hotfix: fix ambiguous column/variable references in issue_delegation_token_v1
-- Root cause: RETURNS TABLE(out cols) introduces plpgsql variables named like columns (e.g. delegation_id).
