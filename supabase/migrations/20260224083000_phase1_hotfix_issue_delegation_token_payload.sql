-- Phase 1 hotfix: issue_delegation_token_v1 must return token_payload for Edge Function JWT signing
-- Root cause: Edge Function signs JWT, but DB function did not return the payload/jti.
...
RETURNS TABLE(delegation_id UUID, token_jwt TEXT, token_payload JSONB)
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
DECLARE
...
BEGIN
  ...
  -- Placeholder hash; Edge Function overwrites token_hash with real JWT hash using jti.
