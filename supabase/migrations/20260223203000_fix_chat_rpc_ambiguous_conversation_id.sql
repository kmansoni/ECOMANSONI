-- =============================================================================
-- Fix: ambiguous "conversation_id" references in chat RPCs
--
-- Context:
-- In PL/pgSQL functions with RETURNS TABLE(conversation_id ...), unqualified
-- references like `conversation_id` can conflict with output variables and
-- table columns, causing:
--   column reference "conversation_id" is ambiguous
--
-- This migration hard-qualifies columns with table aliases.
-- =============================================================================
