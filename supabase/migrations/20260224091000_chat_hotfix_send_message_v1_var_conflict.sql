-- Hotfix: prevent PL/pgSQL variable/column ambiguity in Project B send_message_v1
-- Symptom: column reference "conversation_id" is ambiguous
-- Fix: prefer PL/pgSQL variables when names conflict.
