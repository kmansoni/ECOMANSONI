-- ============================================================================
-- CONTROL PLANE PATCH: route pipeline suppression ops through apply_action
--
-- Purpose (P0 invariants):
--  - Single decision point: even pipeline set/clear goes through apply_action
--  - During pipeline suppression, allowlist must still allow:
...
BEGIN
  ...
  IF v_status = 'accepted' THEN
    ...
    ELSIF p_action_type = 'clear_pipeline_suppression' THEN
      UPDATE public.reels_engine_segment_state
      SET
