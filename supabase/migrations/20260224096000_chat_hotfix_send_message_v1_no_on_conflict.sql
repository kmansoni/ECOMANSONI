-- Hotfix: remove ON CONFLICT from send_message_v1 for compatibility across schema drift
-- Use INSERT + unique_violation handler to keep idempotency when a UNIQUE index exists.
