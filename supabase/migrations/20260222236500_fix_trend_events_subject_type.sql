-- Fix: decision_engine_events.subject_type must be one of ('hashtag','user','post','comment','segment')
-- Trend events should use subject_type='segment' and subject_id=segment_id.

-- Patch start_trend_run_v1 to emit with subject_type='segment'
