  ...
  public: {
    Tables: {
      ...
      ad_creative_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "ad_creative_history_creative_id_fkey"
            columns: ["creative_id"]
            isOneToOne: false
      ...
      age_verification_logs: {
        Row: {
          ...
          user_agent: string | null
          user_id: string
          verification_type: Database["public"]["Enums"]["age_verification_type"]
        }
        Insert: {
          created_at?: string
          failure_reason?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "age_verification_logs_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      bot_conversation_states: {
        ...
        Relationships: [
          {
            foreignKeyName: "bot_conversation_states_bot_id_fkey"
            columns: ["bot_id"]
            isOneToOne: false
            referencedRelation: "bots"
            referencedColumns: ["id"]
      ...
      bot_failed_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "bot_failed_events_bot_id_fkey"
            columns: ["bot_id"]
            isOneToOne: false
            referencedRelation: "bots"
            referencedColumns: ["id"]
      ...
      bot_handlers: {
        ...
        Relationships: [
          {
            foreignKeyName: "bot_handlers_bot_id_fkey"
            columns: ["bot_id"]
            isOneToOne: false
            referencedRelation: "bots"
            referencedColumns: ["id"]
      ...
      bot_runs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "bot_runs_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
      ...
      bot_topics: {
        ...
        Relationships: [
          {
            foreignKeyName: "bot_topics_bot_id_fkey"
            columns: ["bot_id"]
            isOneToOne: false
            referencedRelation: "bots"
            referencedColumns: ["id"]
      ...
      bot_webhook_failed_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "bot_webhook_failed_events_bot_id_fkey"
            columns: ["bot_id"]
            isOneToOne: false
            referencedRelation: "bots"
            referencedColumns: ["id"]
      ...
      business_legal_applications: {
        ...
        Relationships: [
          {
            foreignKeyName: "business_legal_applications_reviewer_admin_id_fkey"
      ...
      business_legal_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "business_legal_documents_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "business_legal_applications"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "business_legal_documents_verified_by_admin_id_fkey"
      ...
      business_legal_status_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "business_legal_status_log_actor_admin_id_fkey"
          ...
          {
            foreignKeyName: "business_legal_status_log_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "business_legal_applications"
            referencedColumns: ["id"]
      ...
      content_rating_labels: {
        Row: {
          ...
          id: string
          labeled_at: string
          labeled_by: Database["public"]["Enums"]["label_source"]
          language_score: number | null
          model_version: string | null
          rating: Database["public"]["Enums"]["content_rating"]
          risky_stunts_score: number | null
      ...
      external_provider_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "external_provider_tokens_provider_id_fkey"
            columns: ["provider_id"]
            isOneToOne: true
            referencedRelation: "external_insurance_providers"
            referencedColumns: ["id"]
          },
        ]
      }
        ...
        Relationships: [
          {
            ...
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "transit_agency"
            referencedColumns: ["id"]
          },
        ]
      }
      gtfs_stop_times: {
        ...
        Relationships: [
          {
            foreignKeyName: "gtfs_stop_times_stop_id_fkey"
            columns: ["stop_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "gtfs_stop_times_trip_id_fkey"
            columns: ["trip_id"]
            isOneToOne: false
      ...
      hashtags: {
        Row: {
          age_restriction: Database["public"]["Enums"]["content_rating"] | null
      ...
      insurance_applications: {
        ...
        Relationships: [
          {
            foreignKeyName: "insurance_applications_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
      ...
      insurance_kbm_cache: {
        Row: {
          ...
          kbm_label: string
          previous_claims_count: number | null
          source: string
        }
        Insert: {
          birth_date_hash: string
      ...
      music_downloads: {
        ...
        Relationships: [
          {
            foreignKeyName: "music_downloads_track_id_fkey"
            columns: ["track_id"]
            isOneToOne: false
      ...
      nav_address_hotspots: {
        ...
        Relationships: [
          {
            foreignKeyName: "nav_address_hotspots_utterance_id_fkey"
            columns: ["utterance_id"]
            isOneToOne: false
            referencedRelation: "nav_voice_utterances"
            referencedColumns: ["id"]
          },
        ]
      }
      nav_address_patterns: {
        Row: {
      ...
      nav_meta_cognition_remediations: {
        Row: {
          action: string
          created_at: string
      ...
      nav_survey_scans: {
        Row: {
          ...
          computed_dimensions: Json | null
          created_at: string
          elevated_geometry: unknown
        ...
        Relationships: [
          {
            foreignKeyName: "nav_survey_scans_source_edit_id_fkey"
            columns: ["source_edit_id"]
            isOneToOne: false
            referencedRelation: "nav_map_edits"
            referencedColumns: ["id"]
          },
        ]
      }
      nav_time_bank_accounts: {
        Row: {
      ...
      nav_voice_feedback: {
        ...
        Relationships: [
          {
            foreignKeyName: "nav_voice_feedback_sample_id_fkey"
            columns: ["sample_id"]
            isOneToOne: false
            referencedRelation: "nav_voice_training_samples"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "nav_voice_feedback_utterance_id_fkey"
            columns: ["utterance_id"]
            isOneToOne: false
            referencedRelation: "nav_voice_utterances"
            referencedColumns: ["id"]
      ...
      nav_voice_training_samples: {
        ...
        Relationships: [
          {
            foreignKeyName: "nav_voice_training_samples_utterance_id_fkey"
            columns: ["utterance_id"]
            isOneToOne: false
            referencedRelation: "nav_voice_utterances"
            referencedColumns: ["id"]
      ...
      parental_links: {
        Row: {
          created_at: string
          daily_usage_limit_minutes: number | null
          id: string
          ...
          settings_sync_enabled: boolean | null
          status: Database["public"]["Enums"]["parental_link_status"]
          teen_acceptance_confirmed_at: string | null
          teen_user_id: string
          updated_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "parental_links_parent_user_id_fkey"
          ...
          {
            foreignKeyName: "parental_links_teen_user_id_fkey"
      ...
      payment_invoice_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "payment_invoice_events_invoice_id_fkey"
            columns: ["invoice_id"]
            isOneToOne: false
      ...
      polls: {
        Row: {
          ...
          created_at: string | null
          description: string | null
          description_parse_mode: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "polls_bot_id_fkey"
            columns: ["bot_id"]
            isOneToOne: false
            referencedRelation: "bots"
            referencedColumns: ["id"]
      ...
      profiles: {
        Row: {
          ...
          age_verification_attempts: number | null
          ...
          content_rating_limit:
            | Database["public"]["Enums"]["content_rating"]
            | null
          created_at: string
          ...
          referral_code: string | null
          restricted_categories: Json | null
          safety_mode_active: boolean | null
          search_vector: unknown
        ...
        Relationships: [
          {
            foreignKeyName: "profiles_parental_guardian_id_fkey"
            columns: ["parental_guardian_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "profiles_teen_mode_enforced_by_fkey"
            columns: ["teen_mode_enforced_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      reel_effects: {
        ...
        Relationships: [
          {
            foreignKeyName: "reel_effects_reel_id_fkey"
            columns: ["reel_id"]
            isOneToOne: false
            referencedRelation: "reels"
            referencedColumns: ["id"]
      ...
      reel_mentions: {
        ...
        Relationships: [
          {
            foreignKeyName: "reel_mentions_reel_id_fkey"
            columns: ["reel_id"]
            isOneToOne: false
            referencedRelation: "reels"
            referencedColumns: ["id"]
      ...
      reel_playback_state: {
        ...
        Relationships: [
          {
            foreignKeyName: "reel_playback_state_reel_id_fkey"
            columns: ["reel_id"]
            isOneToOne: false
            referencedRelation: "reels"
            referencedColumns: ["id"]
      ...
      reel_playlist_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "reel_playlist_items_playlist_id_fkey"
            columns: ["playlist_id"]
            isOneToOne: false
            referencedRelation: "reel_playlists"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "reel_playlist_items_reel_id_fkey"
            columns: ["reel_id"]
            isOneToOne: false
            referencedRelation: "reels"
            referencedColumns: ["id"]
      ...
      road_lane_details: {
        Row: {
          bicycle_lane: boolean | null
          bus_lane: boolean | null
          destination_lanes: string[] | null
          direction: string
          id: string
          lane_count: number
      ...
      stars_revenue_share: {
        ...
        Relationships: [
          {
            foreignKeyName: "stars_revenue_share_transaction_id_fkey"
      ...
      tl_observations: {
        Row: {
          ...
          color_seen: string
          device_speed_kmh: number | null
          duration_seconds: number | null
          id: string
          lat: number
          lon: number
          matched_timing_id: string | null
          timestamp: string
          user_id: string | null
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "tl_observations_matched_timing_id_fkey"
            columns: ["matched_timing_id"]
            isOneToOne: false
            referencedRelation: "traffic_light_timings"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      transit_trip_updates: {
        ...
        Relationships: [
          {
            foreignKeyName: "transit_trip_updates_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "transit_agency"
            referencedColumns: ["id"]
      ...
      turn_active_allocations: {
        Row: {
          ...
          expires_at: string
          ip_hash: string
          region: Database["public"]["Enums"]["turn_region_t"]
          session_id: string | null
          user_id: string | null
        }
        Insert: {
      ...
      turn_active_allocations_2026_05: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2026_06: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2026_07: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2026_08: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2026_09: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2026_10: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2026_11: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2026_12: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2027_01: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2027_02: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2027_03: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2027_04: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_2027_05: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
      ...
      turn_active_allocations_default: {
        Row: {
          allocated_at: string
          expires_at: string
          ip_hash: string
    ...
    Views: {
      ...
      turn_health_check: {
        Row: {
          ...
          region: Database["public"]["Enums"]["turn_region_t"] | null
          status: string | null
          utilization_pct: number | null
        }
        Relationships: []
      }
      turn_region_capacity: {
        Row: {
          active: boolean | null
          domain: string | null
    ...
    Functions: {
      ...
      accept_parental_invite: {
        Args: { p_invite_code: string; p_teen_user_id: string }
        Returns: Json
      }
      ack_delivered_v1: {
      ...
      aggregate_traffic: { Args: never; Returns: Json }
      ...
      atomic_update_session_vars: {
        Args: { p_session_id: string; p_vars: Json }
        Returns: Json
      }
      ...
      calculate_age: { Args: { p_dob: string }; Returns: number }
      ...
      check_age_verification_rate_limit: {
        Args: {
          p_ip_address: unknown
      ...
      cleanup_expired_disappearing_messages: {
        Args: never
        Returns: {
          channel_messages_deleted: number
          group_messages_deleted: number
      ...
      cleanup_expired_turn_allocations: { Args: never; Returns: number }
      cleanup_old_metric_samples_v1: {
        Args: { p_retention_days?: number }
        Returns: Json
      }
      cleanup_old_realtime_data: { Args: never; Returns: undefined }
      ...
      create_map_edit_from_scan: {
        Args: { editor_id?: string; scan_id: string }
        Returns: string
      }
      ...
      cron_cleanup_orphaned_sessions: { Args: never; Returns: undefined }
      cron_retry_webhook_failed_events: { Args: never; Returns: number }
      decrement_viewer_count: {
        Args: { p_session_id: number }
        Returns: undefined
      }
      decrypt_service_key_v1: { Args: { p_encrypted: string }; Returns: string }
      delete_my_account: { Args: { confirmation: string }; Returns: Json }
      ...
      flag_stale_age_verification: { Args: never; Returns: undefined }
      ...
      get_daily_metrics: {
        ...
        Returns: {
          date: string
          orders: number
          orders_marketplace: Json
          profit: number
          revenue: number
          revenue_marketplace: Json
        }[]
      }
      ...
      get_email_by_phone_v1: { Args: { p_phone: string }; Returns: string }
      ...
      get_kpi_metrics: {
        ...
        Returns: {
          ...
          top_performing_product_id: string
          top_performing_product_revenue: number
          top_performing_product_title: string
          total_orders: number
          total_profit: number
          total_revenue: number
        }[]
      ...
      get_neighboring_scans: {
        Args: { p_radius_meters?: number; p_scan_id: string }
        Returns: {
          distance_m: number
          neighbor_id: string
      ...
      get_session_vars: { Args: { p_session_id: string }; Returns: Json }
      get_slo_status_v1: {
        Args: { p_domain?: string; p_lookback_minutes?: number }
        Returns: Json
      }
      get_stripe_secret_for_bot: { Args: { p_bot_id: string }; Returns: string }
      ...
      get_turn_region_load: {
        Args: { p_region?: Database["public"]["Enums"]["turn_region_t"] }
        Returns: {
          active_count: number
      ...
      get_user_rating_limit: {
        Args: { p_user_id: string }
        Returns: Database["public"]["Enums"]["content_rating"]
      }
      get_user_reels_v1: {
      ...
      hamming_distance_hex: {
        Args: { p_hex_a: string; p_hex_b: string }
        Returns: number
      }
      has_role: {
        Args: {
      ...
      hex_to_uint8: { Args: { p_hex: string }; Returns: string }
      ...
      nav_record_voice_feedback: {
        Args: {
          p_confidence?: number
          p_corrected_address?: Json
          p_corrected_transcript: string
          p_feedback_type?: string
          p_novelty_score?: number
          p_sample_source?: string
          p_utterance_id: string
          p_validation_source?: string
        }
        Returns: Json
      }
      nav_record_voice_learning_event: {
        Args: {
          p_accent_tag?: string
          p_language_code?: string
          p_metadata?: Json
          p_novelty_score?: number
          p_parsed_address?: Json
          p_source?: string
          p_transcript_draft: string
          p_transcript_final?: string
      ...
      parent_override_content_limit: {
        Args: {
          p_new_rating: Database["public"]["Enums"]["content_rating"]
          p_parent_id: string
          p_teen_id: string
        }
        Returns: Json
      ...
      record_reel_reaction: {
        Args: { p_emoji: string; p_reel_id: string }
        Returns: undefined
      }
      record_reel_skip:
        | {
      ...
      retry_bot_failed_events: { Args: never; Returns: number }
      review_appeal_v1: {
        Args: {
          p_appeal_id: string
          p_decision: string
      ...
      save_reel_playback: {
        Args: { p_completed?: boolean; p_position: number; p_reel_id: string }
        Returns: undefined
      }
      save_trip: {
        Args: {
      ...
      select_turn_region: {
        Args: { p_client_ip: unknown; p_puid?: string }
        Returns: {
          domain: string
          region: Database["public"]["Enums"]["turn_region_t"]
          turn_urls: Json
      ...
      submit_gps_probes: { Args: { probes: Json }; Returns: Json }
      submit_tl_observation: {
        Args: {
          p_accuracy?: number
          p_color: string
          p_duration?: number
      ...
      track_turn_allocation: {
        Args: {
          p_expires_at: string
          p_ip_hash: string
          p_region: Database["public"]["Enums"]["turn_region_t"]
          p_session_id?: string
          p_user_id: string
        }
        Returns: undefined
      ...
      trigger_post_reminder_notifications: { Args: never; Returns: undefined }
    ...
    Enums: {
      ...
      age_tier: "adult" | "teen" | "child_supervised"
      ...
      content_rating: "G" | "PG" | "PG-13" | "T" | "MA" | "NSFW"
      content_type:
        | "post"
        | "reel"
        | "comment"
      ...
      moderation_decision_type:
        ...
        | "hidden"
        | "quarantined"
      parental_link_status: "pending" | "active" | "revoked" | "expired"
...
export const Constants = {
  ...
  public: {
    Enums: {
      ...
      commission_status: ["pending", "confirmed", "paid", "cancelled"],
      content_rating: ["G", "PG", "PG-13", "T", "MA", "NSFW"],
      content_type: ["post", "reel", "comment", "message", "profile", "story"],
      deal_type: ["sale", "rent", "daily"],
      decision_job_priority: ["low", "normal", "high", "critical"],
      decision_job_status: [
        "pending",
