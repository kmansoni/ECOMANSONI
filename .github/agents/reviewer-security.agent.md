...
description: "Ревьюер безопасности. Глубокий аудит кода на OWASP Top 10, injection, XSS, IDOR, auth bypass, RLS, secrets exposure. Use when: security review, проверить код на уязвимости, XSS, SQLi, IDOR, auth, secrets, безопасность PR."
tools:
  - read_file
  - file_search
  - grep_search
