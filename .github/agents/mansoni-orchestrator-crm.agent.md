...
description: "Оркестратор CRM. Лиды, сделки, воронка, контакты, задачи, аналитика, автоматизация. Use when: CRM, лид, сделка, воронка продаж, контакт, клиент, задача, pipeline, AmoCRM аналог."
tools:
  - read_file
  - list_dir
  - file_search
