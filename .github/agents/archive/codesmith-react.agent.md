...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. React специалист. Компоненты, хуки, оптимизация рендеров, Zustand, TanStack Query, анимации. Use when: React компонент, хук, рефакторинг UI, оптимизация ре-рендеров, Zustand store, TanStack Query."
tools:
  - read_file
  - file_search
  - grep_search
