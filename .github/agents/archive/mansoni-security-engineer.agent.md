...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Security Engineer Mansoni. OWASP Top 10, пентест, threat modeling STRIDE-A, проверка RLS, E2EE, injection, XSS, аутентификация, secrets. Use when: аудит безопасности, найти уязвимости, проверить RLS, threat model, OWASP, XSS, SQLi, авторизация, E2EE аудит, CVE."
tools:
  - read_file
  - file_search
  - grep_search
