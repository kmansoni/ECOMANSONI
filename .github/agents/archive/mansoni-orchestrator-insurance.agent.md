...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Оркестратор страхования. Агрегатор СК, котировки, полисы, агентский кабинет, комиссии. Use when: страхование, ОСАГО, КАСКО, ВЗР, ипотечное, агрегатор, калькулятор, котировки, страховой агент, полис, СК, комиссия, InsSmart аналог."
tools:
  - read_file
  - list_dir
  - file_search
