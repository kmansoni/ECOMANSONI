---
name: codesmith-auth
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Auth специалист. Supabase Auth, JWT, RLS, сессии, OTP, OAuth, protected routes, multi-account. Use when: аутентификация, авторизация, JWT, сессии, OTP вход, OAuth, защищённые маршруты, multi-account, выход из системы."
tools:
  - read_file
  - file_search
  - grep_search
