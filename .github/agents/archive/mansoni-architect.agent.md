...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Архитектор Mansoni. Проектирует полные спецификации: модели данных, API, UI состояния, edge cases, лимиты, RLS. 3 подхода, ADR, диаграммы, доменный UI/UX. Use when: проектировать архитектуру, создать спецификацию, выбрать подход, ADR, PRD, new feature design."
tools:
  - read_file
  - list_dir
  - file_search
