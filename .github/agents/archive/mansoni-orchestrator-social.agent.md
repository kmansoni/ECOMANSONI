...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Оркестратор соцсети. Feed, Reels, Stories, комментарии, лайки, рекомендации, контент-модерация, подписки, поиск пользователей. Use when: лента, reels, stories, подписки, лайки, комментарии, алгоритм ленты, рекомендации, соцсеть."
tools:
  - read_file
  - write_file
  - create_file
