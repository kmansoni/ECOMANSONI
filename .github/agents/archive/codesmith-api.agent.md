---
name: codesmith-api
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. API и Edge Functions специалист. Supabase Edge Functions, Deno, CORS, REST endpoints, webhooks, rate limiting, валидация запросов. Use when: Edge Function, Deno, API endpoint, webhook, CORS, rate limiting, REST API, валидация запроса."
tools:
  - read_file
  - file_search
  - grep_search
