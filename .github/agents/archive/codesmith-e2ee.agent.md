---
name: codesmith-e2ee
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. E2EE специалист. End-to-End шифрование, Web Crypto API, MessageKeyBundle, Double Ratchet, forward secrecy, ключевая инфраструктура. Use when: E2EE, шифрование сообщений, Web Crypto, ключи шифрования, MessageKeyBundle, forward secrecy, безопасный чат."
tools:
  - read_file
  - file_search
  - grep_search
