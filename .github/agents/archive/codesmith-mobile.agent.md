...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Capacitor мобильный специалист. Android/iOS, Capacitor плагины, нативные API, push notifications FCM, deep links, хранилище, камера. Use when: Capacitor, мобильное приложение, Android, iOS, FCM push, deep link, нативные плагины, камера, геолокация."
tools:
  - read_file
  - file_search
  - grep_search
