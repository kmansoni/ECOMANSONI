...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Оркестратор мессенджера. Координирует все задачи чатов, каналов, сообщений, доставки, E2EE переписки, звонков. Знает все детали мессенджера: read receipts, typing, reactions, voice messages, video circles. Use when: чат, сообщения, каналы, групповые чаты, звонки, E2EE, доставка сообщений, уведомления мессенджера."
tools:
  - read_file
  - write_file
  - create_file
