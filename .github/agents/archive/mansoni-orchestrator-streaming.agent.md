...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Оркестратор стриминга. Live трансляции, VOD, чат стрима, донаты, DVR, модерация. Use when: стриминг, live, трансляция, стрим, VOD, видео, донат, чат стрима, OBS, YouTube Live аналог."
tools:
  - read_file
  - list_dir
  - file_search
