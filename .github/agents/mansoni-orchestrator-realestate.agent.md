...
description: "Оркестратор недвижимости. Объекты, поиск на карте, фильтры, ипотечный калькулятор, виртуальные туры. Use when: недвижимость, квартира, дом, объявление, аренда, покупка, ипотека, карта, ЦИАН аналог, RealEstate."
tools:
  - read_file
  - list_dir
  - file_search
