...
description: "Performance Engineer Mansoni. Core Web Vitals, bundle size, virtual scroll, lazy loading, profiling, caching, PostgreSQL query optimization. Use when: медленная загрузка, тормозит UI, большой бандл, N+1 запросы, медленные запросы БД, Core Web Vitals, LCP, CLS, INP."
tools:
  - read_file
  - file_search
  - grep_search
