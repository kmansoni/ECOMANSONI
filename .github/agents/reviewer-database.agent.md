...
description: "Ревьюер базы данных. Аудит SQL-миграций, RLS-политик, индексов, типов данных, FOREIGN KEY, триггеров, хранимых процедур. Use when: database review, миграция, RLS политика, индекс, SQL функция, триггер, integrity, нормализация."
tools:
  - read_file
  - file_search
  - grep_search
