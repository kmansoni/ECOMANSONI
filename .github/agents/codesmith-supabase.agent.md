...
description: "Supabase специалист. RLS, миграции, Edge Functions, Realtime, Storage, Auth, PostgreSQL. Use when: миграция, RLS policy, Edge Function, Deno, Supabase Realtime, Storage, PostgreSQL функция, триггер."
tools:
  - read_file
  - file_search
  - grep_search
