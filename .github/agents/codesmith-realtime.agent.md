...
description: "Realtime специалист. Supabase Realtime, WebSocket, Broadcast, Presence, reconnect стратегии, typing indicator. Use when: realtime, WebSocket подписки, Supabase Realtime, typing indicator, онлайн-статус, live updates, Broadcast, Presence."
tools:
  - read_file
  - file_search
  - grep_search
