...
description: "Ревьюер архитектуры. Аудит структурных решений: coupling, cohesion, SOLID, DRY, инварианты, компонент >400 строк, дублирование логики, неверный слой абстракции. Use when: architecture review, SOLID нарушение, компонент слишком большой, неправильная абстракция, coupling, модульность."
tools:
  - read_file
  - file_search
  - grep_search
