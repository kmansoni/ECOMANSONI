...
(function (JoinMode) {
    ...
    JoinMode["INVITE_ONLY"] = "invite_only";
})(JoinMode || (JoinMode = {}));
/**
 ...
 */
export var DeliveryStrategy;
(function (DeliveryStrategy) {
    DeliveryStrategy["FANOUT_ON_WRITE"] = "fanout_on_write";
    DeliveryStrategy["FANOUT_ON_READ"] = "fanout_on_read";
...
export const CLASSIFICATION_RETENTION_DAYS = {
...
(function (CommandType) {
    CommandType["CREATE_SCOPE"] = "create_scope";
    CommandType["SEND_MESSAGE"] = "send_message";
    CommandType["SEND_MESSAGE_REPLY"] = "send_message_reply";
    CommandType["EDIT_MESSAGE"] = "edit_message";
    CommandType["DELETE_MESSAGE"] = "delete_message";
    CommandType["UPDATE_SCOPE_POLICY"] = "update_scope_policy";
    CommandType["ACCEPT_INVITE"] = "accept_invite";
    CommandType["REJECT_INVITE"] = "reject_invite";
    CommandType["INVITE_USER"] = "invite_user";
    CommandType["REMOVE_MEMBER"] = "remove_member";
    CommandType["UPDATE_MEMBERSHIP"] = "update_membership";
    CommandType["RECORD_RECEIPT"] = "record_receipt";
    CommandType["UPDATE_PROJECTION_WATERMARK"] = "update_projection_watermark";
 ...
 */
export var AdminReasonCode;
(function (AdminReasonCode) {
    AdminReasonCode["ABUSE_SPAM"] = "abuse_spam";
    AdminReasonCode["ABUSE_HARASSMENT"] = "abuse_harassment";
    AdminReasonCode["LEGAL_REQUEST"] = "legal_request";
    AdminReasonCode["USER_REQUEST"] = "user_request";
    AdminReasonCode["SECURITY_INCIDENT"] = "security_incident";
    AdminReasonCode["MODERATION_POLICY"] = "moderation_policy";
    AdminReasonCode["OTHER"] = "other";
})(AdminReasonCode || (AdminReasonCode = {}));
/**
...
(function (MaintenanceMode) {
    ...
    MaintenanceMode["MAINTENANCE_WRITE_FREEZE"] = "maintenance_write_freeze";
    MaintenanceMode["READ_ONLY_SAFE"] = "read_only_safe";
    MaintenanceMode["MAINTENANCE_FULL"] = "maintenance_full";
...
export const MAINTENANCE_FORBIDDEN_TRANSITIONS = [
...
(function (ProjectionMode) {
    ProjectionMode["NORMAL"] = "normal";
    ProjectionMode["REBUILDING"] = "rebuilding";
    ProjectionMode["READ_ONLY"] = "read_only";
 ...
 */
export const LARGE_CHANNEL_MIN_MEMBER_COUNT = 50000;
/**
