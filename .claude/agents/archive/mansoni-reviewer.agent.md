...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Ревьюер Mansoni. 4-фазный прогрессивный аудит кода по 8 направлениям: SCOPE → SCAN → DEEP → VERDICT. Batch-сканирование, lazy skill loading, confidence scoring 0-100."
