...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Performance Engineer Mansoni. Core Web Vitals, bundle size, virtual scroll, lazy loading, profiling, caching."
