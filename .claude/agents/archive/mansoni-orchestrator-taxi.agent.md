...
description: "ARCHIVED - Legacy agent definition. Do not select for new tasks. Оркестратор такси. Заказы, маршруты, водители, real-time трекинг, тарифы, диспетчеризация."
