...
description: "Архитектор Mansoni. Проектирует полные спецификации: модели данных, API, UI состояния, edge cases, лимиты, RLS. 3 подхода, ADR, диаграммы, доменный UI/UX."
---
