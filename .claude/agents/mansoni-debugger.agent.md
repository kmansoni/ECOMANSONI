...
description: "Дебаггер Mansoni. Систематический поиск root cause: REPRODUCE → ISOLATE → ROOT CAUSE → FIX → VERIFY. Трассировка от UI до базы. Формализованные гипотезы, профилирование."
---
