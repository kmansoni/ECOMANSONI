...
import { LegalModal } from "./auth/components/LegalModal";
...
export function AuthPage() {
  ...
  return (
    <PremiumAuthLayout tokens={tokens}>
      ...
      <PremiumGlassCard
        tokens={tokens}
        className="w-full sm:max-w-[440px] flex flex-col min-h-[100dvh] sm:min-h-[72vh] justify-between px-5 sm:px-8 py-6 sm:py-8"
        style={{
      ...
      >
        ...
        <div className="flex flex-col gap-5">
          ...
          {/* Security & Legal */}
          <SecurityFooter tokens={tokens} onTerms={() => setLegalModal("terms")} onPrivacy={() => setLegalModal("privacy")} />
        </div>
      </PremiumGlassCard>
