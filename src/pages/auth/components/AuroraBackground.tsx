...
export function AuroraBackground({ theme }: { theme: Theme }) {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden" aria-hidden>
      <div
        ...
        style={{
          background: dark
            ...
            : "linear-gradient(165deg, #a7f3d0 0%, #99f6e4 22%, #a5f3fc 48%, #bae6fd 72%, #c7d2fe 100%)",
        }}
      />
      {!dark && (
        <div
          ...
          style={{
            background:
              "radial-gradient(70% 50% at 88% 8%, rgba(20,184,166,0.55) 0%, transparent 70%)," +
              "radial-gradient(60% 45% at 8% 92%, rgba(99,102,241,0.45) 0%, transparent 72%)," +
              "radial-gradient(50% 40% at 50% 50%, rgba(56,189,248,0.25) 0%, transparent 75%)",
          }}
        />
      )}
      {(dark
      ...
      <div
        className={`absolute inset-0 pointer-events-none ${
          dark ? "opacity-[0.06] mix-blend-overlay" : "opacity-[0.07] mix-blend-multiply"
        }`}
        style={{
          backgroundImage:
