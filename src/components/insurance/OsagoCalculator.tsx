  ...
  return (
    <div className="rounded-2xl border border-border/50 bg-card p-4 shadow-sm">
      <div className="mb-5 flex items-center gap-3">
        ...
        <div>
          <h2 className="text-base font-semibold">Быстрый расчёт ОСАГО</h2>
          <p className="text-sm text-muted-foreground">Заполните параметры автомобиля и водителя, чтобы увидеть ориентировочную стоимость.</p>
        </div>
      </div>
